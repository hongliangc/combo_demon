...
func show_toast(message: String, duration: float = 2.0, message_type: String = "info") -> void:
	var toast_scene := preload("res://Scenes/UI/Components/Toast.tscn")
...
func show_confirm_dialog(
	...
	var dialog_scene := preload("res://Scenes/UI/Components/ConfirmDialog.tscn")
...
func load_scene_async(scene_path: String) -> void:
	var loading_screen := preload("res://Scenes/UI/Screens/Loading/LoadingScreen.tscn").instantiate()
