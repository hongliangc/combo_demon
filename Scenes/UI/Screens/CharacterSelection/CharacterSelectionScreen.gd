...
##
## 特性：
## - 自动加载 res://Core/Data/Characters/ 目录下的角色数据
## - 使用轮播容器展示角色卡片
## - 支持键盘/按钮控制选择
...
# 常量
const CharacterCardScene: PackedScene = preload("res://Scenes/UI/Screens/CharacterSelection/CharacterCard.tscn")
...
func _auto_load_characters() -> void:
	var dir_path = "res://Core/Data/Characters/"
