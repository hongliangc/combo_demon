class_name Bear extends AgentBase

## Bear 敌人 — AgentBase + AIController + SkillSet 架构
## 行为: Idle ↔ Chase → Dispatcher → BearAttack; Hit / Death 标准处理
## 无 Wander。BearAttack 普通攻击; 20% 概率附加震地重击 AOE。
