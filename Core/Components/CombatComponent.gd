...
## 子类可重写 process_skill_input() 等方法实现自定义逻辑
...
func _setup_default_skills() -> void:
	...
	add_skill("atk_2", {
		...
		"sound_effect": preload("res://Assets/Sound/sp_atk.mp3"),
		"time_scale": 2.0,
		"disable_movement": true
	})
	...
	add_skill("atk_sp", {
		...
		"sound_effect": preload("res://Assets/Sound/face_the_wind.mp3"),
		"time_scale": 2.0,
