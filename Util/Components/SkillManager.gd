...
# ============ 预加载 ============
const AfterImageEffectScript = preload("res://Util/Effects/AfterImageEffect.gd")
const GhostExpandEffectScript = preload("res://Util/Effects/GhostExpandEffect.gd")
const VortexEffectScript = preload("res://Util/Effects/VortexEffect.gd")
